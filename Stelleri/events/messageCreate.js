    ...
    execute(message) {
        ...
        if (message.guildId) {
            ...
            switch(message.content) {
                case "decline":
                    operatorInviteHandler.handleDecline(message);
                    break;
                default:
                    message.reply("Hello there! This message is not a valid DM command, or you sent it to the wrong person. Have a nice day 👋✌!");
                    break;
            }
        }
    }
