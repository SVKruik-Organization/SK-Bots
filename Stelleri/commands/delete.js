...
module.exports = {
    ...
    async execute(interaction) {
        ...
        for (let i = 0; i < modules.guilds.length; i++) {
            await rest.delete(Routes.applicationGuildCommand(interaction.applicationId, modules.guilds[i].guildObject.id, commandId))
                .then(() => {
