...
router.put('/update/settings', jwtUtils.authenticateInternalComms, function (req, res) {
...
router.get('/picture', jwtUtils.authenticateInternalComms, async function (req, res) {
